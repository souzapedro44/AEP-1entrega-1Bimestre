...
O documento de arquitetura e requisitos (AEP 1º Bimestre), com a descoberta do problema, os stakeholders, a matriz de rastreabilidade, a justificativa técnica e os diagramas de classes e de banco de dados, está disponível em [`docs/1 - AEP_1Bimestre_Marido_de_Aluguel NOVO.pdf`](docs/1%20-%20AEP_1Bimestre_Marido_de_Aluguel%20NOVO.pdf).
...
A justificativa completa dessas escolhas está na seção 5 do documento em [`docs/1 - AEP_1Bimestre_Marido_de_Aluguel NOVO.pdf`](docs/1%20-%20AEP_1Bimestre_Marido_de_Aluguel%20NOVO.pdf).
...
- [`docs/1 - Diagrama-classes-UML NOVO.png`](docs/1%20-%20Diagrama-classes-UML%20NOVO.png)
- [`docs/1 - Diagrama banco Der.png`](docs/1%20-%20Diagrama%20banco%20Der.png)
