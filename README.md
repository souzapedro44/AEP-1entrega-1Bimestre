...
O documento de arquitetura e requisitos (AEP 1º Bimestre), com a descoberta do problema, os stakeholders, a matriz de rastreabilidade, a justificativa técnica e os diagramas de classes e de banco de dados, está disponível em [`docs/AEP_1Bimestre_Marido_de_Aluguel.pdf`](docs/AEP_1Bimestre_Marido_de_Aluguel.pdf).
...
A justificativa completa dessas escolhas está na seção 5 do documento em [`docs/AEP_1Bimestre_Marido_de_Aluguel.pdf`](docs/AEP_1Bimestre_Marido_de_Aluguel.pdf).
...
- [`docs/diagrama-classes-uml.png`](docs/diagrama-classes-uml.png)
- [`docs/diagrama-banco-der.png`](docs/diagrama-banco-der.png)
